...
import { useExperienceMotion } from './hooks';
...
export function Experience() {
  ...
  return (
    <section
      ...
      className="curtain-panel bg-secondary relative z-10 min-h-svh text-white lg:h-svh lg:max-h-svh lg:overflow-hidden"
    >
      <div className="bg-secondary px-page sticky top-0 flex min-h-svh items-center pt-28 pb-8 lg:h-svh lg:min-h-0 lg:overflow-hidden lg:pb-6">
        <div className="w-full">
          ...
          >
            <h2
              ...
              className="text-7xl leading-none font-medium tracking-tight"
            >
              {t('title')}
            </h2>
